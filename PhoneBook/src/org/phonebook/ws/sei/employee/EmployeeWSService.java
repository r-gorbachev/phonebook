 ...
 * 
 */
@WebServiceClient(name = "EmployeeWSService", targetNamespace = "http://phonebook.org/ws", wsdlLocation = "http://localhost:8080/EmployeeWSService/EmployeeWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEEWSSERVICE_QNAME = new QName("http://phonebook.org/ws", "EmployeeWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EmployeeWSService/EmployeeWS?wsdl");
    ...
    public EmployeeWS getEmployeeWSPort() {
        return super.getPort(new QName("http://phonebook.org/ws", "EmployeeWSPort"), EmployeeWS.class);
    }
    ...
    public EmployeeWS getEmployeeWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://phonebook.org/ws", "EmployeeWSPort"), EmployeeWS.class, features);
    }
